...
AUTO_INCREMENT=71 AVG_ROW_LENGTH=234 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
#
# Data for the `tbl_car_programas_actividades_valores` table  (LIMIT -498,500)
#

INSERT INTO `tbl_car_programas_actividades_valores` (`id_car_programas_actividades`, `id_car_programa`, `descripcion`, `rango`, `rango_tipo`, `dosis`, `intervalo`, `intervalo_tipo`, `sexo`) VALUES 
  (1,1,'Vacunación con BCG, HB, VOP',0,'dias',1,NULL,NULL,'ambos');
COMMIT;
...
INSERT INTO `tbl_persona` (`id_persona`, `id_documento_tipo`, `documento`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `id_tarjeta_familiar`, `id_estado_civil`, `id_asegurador`, `id_nivel_educativo`, `sexo`, `fecha_nacimiento`, `id_persona_familiaridad`) VALUES 
  (1,1,'1','niño','1','apellido','2',1,1,1,1,'Masculino','2014-01-03',1),
