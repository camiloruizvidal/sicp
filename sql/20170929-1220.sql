...
CREATE TABLE `tbl_asegurador` (
  ...
  `regimen` VARCHAR(200) COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_asegurador`)
)ENGINE=InnoDB
AUTO_INCREMENT=11 AVG_ROW_LENGTH=2048 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
#
# Data for the `tbl_asegurador` table  (LIMIT -491,500)
#

INSERT INTO `tbl_asegurador` (`id_asegurador`, `descripcion`, `regimen`) VALUES 
  (3,'SALUDVIDA','SUBSIDIADO'),
  (4,'AIC','CONTRIBUTIVO'),
  (5,'ASMET','RE ESPECIAL'),
  (6,'CAFESALUD','VINCULADO'),
  (7,'COOMEVA','DESP VINCU'),
  (8,'COMFENALCO','DEZP SUB'),
  (9,'NUEVA EPS','DEZP CONT'),
  (10,'MAGISTERIO','CABEZA DE FAMILIA');
COMMIT;
...
INSERT INTO `tbl_tarjeta_familiar` (`id_tarjeta_familiar`, `fecha_apertura`, `codigo`, `sisben_ficha`, `sisben_puntaje`, `sisben_nivel`, `direccion`, `id_zona`, `telefono`, `id_municipio`, `id_corregimiento`, `id_vereda`, `portabilidad`, `cambio_domicilio`) VALUES 
  (1,'2017-08-29 18:14:05','82',1,1.000,1,'1',1,'1',NULL,NULL,NULL,'no','no');
COMMIT;
