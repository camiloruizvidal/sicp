...
#
# Structure for the `tbl_morbilidad` table : 
#

CREATE TABLE `tbl_morbilidad` (
  `id_morbilidad` INTEGER(11) NOT NULL AUTO_INCREMENT,
  ...
  `causa` TEXT COLLATE latin1_swedish_ci NOT NULL,
...
AUTO_INCREMENT=3 AVG_ROW_LENGTH=2340 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=2 AVG_ROW_LENGTH=8192 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
AUTO_INCREMENT=251 AVG_ROW_LENGTH=71 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
#
# Definition for the `view_car_programas_actividades_valores` view : 
#

CREATE VIEW `view_car_programas_actividades_valores`
AS
select 
...
#
# Data for the `tbl_corregimientos` table  (LIMIT -478,500)
#
...
#
# Data for the `tbl_morbilidad` table  (LIMIT -497,500)
#
...
INSERT INTO `tbl_morbilidad` (`id_morbilidad`, `nombres`, `apellidos`, `fecha_nacimientod`, `causa`, `fecha_fallecimiento`, `id_tarjeta_familiar`) VALUES 
  (1,'1','1','2017-09-05','1','2017-09-05',1),
  (2,'2','2','2017-09-06','2','2017-09-15',1);
COMMIT;
...
#
# Data for the `tbl_persona` table  (LIMIT -497,500)
#
...
INSERT INTO `tbl_persona` (`id_persona`, `id_documento_tipo`, `documento`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `id_tarjeta_familiar`, `id_estado_civil`, `id_nivel_educativo`, `sexo`, `fecha_nacimiento`, `id_persona_familiaridad`, `tipo_afiliado`, `id_asegurador`, `id_rango`, `id_regimen`, `es_cabeza_familia`, `ocupacion`) VALUES 
  (1,5,'1','1','1','1','1',1,2,4,'Masculino','2011-09-01',-1,'COTIZANTE',10,1,NULL,'si',''),
  (2,5,'2','2','2','2','2',1,2,4,'Masculino','2017-09-06',-1,'COTIZANTE',10,1,NULL,'no','2');
COMMIT;
...
INSERT INTO `tbl_tarjeta_familiar` (`id_tarjeta_familiar`, `fecha_apertura`, `codigo`, `sisben_ficha`, `sisben_puntaje`, `sisben_nivel`, `direccion`, `id_zona`, `telefono`, `id_municipio`, `id_corregimiento`, `id_vereda`, `portabilidad`, `cambio_domicilio`, `proxima_visita`, `responsable`, `documento_responsable`) VALUES 
  (1,'2017-09-04 22:45:44','2',1,1.000,1,'1',1,'1',430,-1,-1,'no','no','2017-09-04','usuario prueba','1');
COMMIT;
...
#
# Data for the `tbl_veredas` table  (LIMIT -270,500)
#
