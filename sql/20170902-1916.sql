...
AUTO_INCREMENT=9 AVG_ROW_LENGTH=2340 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
INSERT INTO `tbl_persona` (`id_persona`, `id_documento_tipo`, `documento`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `id_tarjeta_familiar`, `id_estado_civil`, `id_nivel_educativo`, `sexo`, `fecha_nacimiento`, `id_persona_familiaridad`, `tipo_afiliado`, `id_asegurador`, `id_rango`, `id_regimen`, `es_cabeza_familia`) VALUES 
  (1,5,'1','1','1','1','1',1,2,4,'Masculino','1959-05-01',-1,'COTIZANTE',10,1,NULL,'no'),
  (7,5,'2','2','2','2','2',1,2,4,'Masculino','1947-09-01',-1,'COTIZANTE',10,1,NULL,'no'),
  (8,5,'3','3','3','3','3',1,1,4,'Femenino','2010-03-03',-1,'COTIZANTE',10,1,NULL,'no');
COMMIT;
...
INSERT INTO `tbl_tarjeta_familiar` (`id_tarjeta_familiar`, `fecha_apertura`, `codigo`, `sisben_ficha`, `sisben_puntaje`, `sisben_nivel`, `direccion`, `id_zona`, `telefono`, `id_municipio`, `id_corregimiento`, `id_vereda`, `portabilidad`, `cambio_domicilio`, `proxima_visita`) VALUES 
  (1,'2017-09-02 05:51:17','5',1,1.000,11,'1',1,'1',430,-1,-1,'no','no','2017-09-01');
COMMIT;
