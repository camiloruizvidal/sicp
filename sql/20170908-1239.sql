...
CREATE TABLE IF NOT EXISTS `tbl_asegurador` (
  `id_asegurador` int(11) NOT NULL AUTO_INCREMENT,
  `codigo` varchar(20) DEFAULT NULL,
  `descripcion` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id_asegurador`)
) ENGINE=InnoDB AUTO_INCREMENT=29 AVG_ROW_LENGTH=2048 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_car_categoria` (
  `id_car_categoria` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(200) DEFAULT NULL,
  `orden` int(11) DEFAULT NULL,
  `tipo` enum('persona','ficha') NOT NULL DEFAULT 'persona',
  PRIMARY KEY (`id_car_categoria`)
) ENGINE=InnoDB AUTO_INCREMENT=12 AVG_ROW_LENGTH=1820 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_car_programas` (
  `id_car_programas` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id_car_programas`)
) ENGINE=InnoDB AUTO_INCREMENT=16 AVG_ROW_LENGTH=1092 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tbl_car_programas_actividades` (
  `id_car_programas_actividades` int(11) NOT NULL AUTO_INCREMENT,
  `id_car_programa` int(11) DEFAULT NULL,
  `descripcion` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id_car_programas_actividades`)
) ENGINE=InnoDB AUTO_INCREMENT=71 AVG_ROW_LENGTH=244 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_car_programas_actividades_valores` (
  `id_car_programas_actividades` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=147 AVG_ROW_LENGTH=1820 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tbl_car_registro` (
  `id_car_registro` int(11) NOT NULL AUTO_INCREMENT,
  `value` text,
  `id_persona` int(11) DEFAULT NULL,
  `id_tarjeta_familiar` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_car_registro`)
) ENGINE=InnoDB AUTO_INCREMENT=6 AVG_ROW_LENGTH=4096 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_car_tipo_dato` (
  `id_car_tipo_dato` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(200) DEFAULT NULL,
  PRIMARY KEY (`id_car_tipo_dato`)
) ENGINE=InnoDB AUTO_INCREMENT=11 AVG_ROW_LENGTH=1638 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_car_variables` (
  `id_car_variables` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=100 AVG_ROW_LENGTH=186 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tbl_car_variablexcategoria` (
  `id_car_variablexcategoria` int(11) NOT NULL AUTO_INCREMENT,
  `id_car_variables` int(11) DEFAULT NULL,
  `id_car_categoria` int(11) DEFAULT NULL,
  `orden` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_car_variablexcategoria`)
) ENGINE=InnoDB AUTO_INCREMENT=99 AVG_ROW_LENGTH=188 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_codigos` (
  `id_codigos` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `tbl_corregimientos` (
  `id_corregimiento` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(200) DEFAULT NULL,
  `id_municipio` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_corregimiento`)
) ENGINE=InnoDB AUTO_INCREMENT=22 AVG_ROW_LENGTH=780 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=33 AVG_ROW_LENGTH=512 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_documento_tipo` (
...
) ENGINE=InnoDB AUTO_INCREMENT=8 AVG_ROW_LENGTH=8192 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_morbilidad` (
  `id_morbilidad` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=4 AVG_ROW_LENGTH=8192 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=1103 AVG_ROW_LENGTH=74 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=6 AVG_ROW_LENGTH=8192 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_perfil_tipo` (
  `id_perfil_tipo` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(200) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=5 AVG_ROW_LENGTH=2340 DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tbl_persona_familiaridad` (
  `id_persona_familiaridad` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(200) DEFAULT NULL,
  `sexo` char(20) DEFAULT NULL COMMENT 'm=masculino\r\nf=femenino\r\n0=neutro',
  PRIMARY KEY (`id_persona_familiaridad`)
) ENGINE=InnoDB AUTO_INCREMENT=13 AVG_ROW_LENGTH=1365 DEFAULT CHARSET=latin1;
...
) ENGINE=InnoDB AUTO_INCREMENT=8 AVG_ROW_LENGTH=2340 DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `tbl_tarjeta_familiar` (
  `id_tarjeta_familiar` int(11) NOT NULL AUTO_INCREMENT,
...
) ENGINE=InnoDB AUTO_INCREMENT=3 AVG_ROW_LENGTH=8192 DEFAULT CHARSET=latin1;
...
(1, '1', 'c4ca4238a0b923820dcc509a6f75849b', 1, 1, '1', '1', '1'),
...
CREATE TABLE IF NOT EXISTS `tbl_veredas` (
  `id_vereda` int(11) NOT NULL AUTO_INCREMENT,
  `descripcion` varchar(200) NOT NULL,
  `id_municipio` int(11) NOT NULL,
  PRIMARY KEY (`id_vereda`)
) ENGINE=InnoDB AUTO_INCREMENT=251 AVG_ROW_LENGTH=71 DEFAULT CHARSET=latin1;
...
--
CREATE TABLE IF NOT EXISTS `view_car_programas_actividades_valores` (
