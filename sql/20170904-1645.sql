...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 04-09-2017 a las 23:45:01
...
(1, 5, '1', '1', '1', '1', '1', 1, 2, 4, 'Masculino', '2010-09-04', -1, 'COTIZANTE', 10, 1, NULL, 'no', '');
...
--
ALTER TABLE `tbl_codigos`
  MODIFY `id_codigos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `tbl_corregimientos`
  MODIFY `id_corregimiento` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
