...
--
-- Estructura de tabla para la tabla `tbl_encuestador`
--
...
--
-- Volcado de datos para la tabla `tbl_encuestador`
--
...
CREATE TABLE `tbl_persona` (
  ...
  `id_persona_familiaridad` int(11) NOT NULL COMMENT '0=no\r\n1=si',
  `portabilidad` char(2) DEFAULT 'no',
  `cambio_domicilio` varchar(2) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 PACK_KEYS=0;
...
INSERT INTO `tbl_persona` (`id_persona`, `id_documento_tipo`, `documento`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `id_tarjeta_familiar`, `id_estado_civil`, `id_asegurador`, `id_nivel_educativo`, `sexo`, `fecha_nacimiento`, `id_persona_familiaridad`, `portabilidad`, `cambio_domicilio`) VALUES
(1, 1, '1', 'niño', '1', 'apellido', '2', 1, 1, 1, 1, 'Femenino', '2017-08-28', 1, NULL, NULL),
(13, 1, '2', '2', '2', '2', '2', 1, 1, 2, 2, 'Femenino', '2017-08-02', 1, NULL, NULL),
(14, 1, '121', '1212', '1212', '1212', '1212', 1, 1, 1, 1, 'Masculino', '2017-08-02', 1, NULL, NULL),
(15, 1, '3123123', '1212233', '12124324', '121242342', '1212342342', 1, 1, 1, 1, 'Masculino', '2017-08-03', 10, NULL, NULL),
(16, 1, 'milo', '1212233', '12124324', '121242342', '1212342342', 1, 1, 1, 1, 'Masculino', '2017-08-03', 10, NULL, NULL),
(17, 1, '12', '12', '112', '112', '1212', 1, 2, 1, 1, 'Masculino', '2017-08-27', 1, NULL, NULL),
(18, 1, '1071263', '12', '112', '112', '1212', 1, 2, 1, 1, 'Masculino', '2000-04-11', 1, NULL, NULL);
...
INSERT INTO `tbl_tarjeta_familiar` (`id_tarjeta_familiar`, `fecha_apertura`, `codigo`, `sisben_ficha`, `sisben_puntaje`, `sisben_nivel`, `direccion`, `id_zona`, `telefono`, `id_municipio`, `id_corregimiento`, `id_vereda`) VALUES
(1, '2017-08-28 04:09:42', '82', 1, 1.000, 1, '1', 1, '1', NULL, NULL, NULL);
...
--
-- Indices de la tabla `tbl_encuestador`
--
ALTER TABLE `tbl_encuestador`
  ADD PRIMARY KEY (`id_encuestador`);
...
--
ALTER TABLE `tbl_asegurador`
  MODIFY `id_asegurador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT de la tabla `tbl_car_categoria`
--
ALTER TABLE `tbl_car_categoria`
  MODIFY `id_car_categoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `tbl_car_programas_actividades_valores`
  MODIFY `id_car_programas_actividades` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
--
...
--
ALTER TABLE `tbl_car_variables`
  MODIFY `id_car_variables` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=99;
--
-- AUTO_INCREMENT de la tabla `tbl_car_variablexcategoria`
--
ALTER TABLE `tbl_car_variablexcategoria`
  MODIFY `id_car_variablexcategoria` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=98;
--
-- AUTO_INCREMENT de la tabla `tbl_codigos`
--
ALTER TABLE `tbl_codigos`
  MODIFY `id_codigos` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
...
--
-- AUTO_INCREMENT de la tabla `tbl_encuestador`
--
ALTER TABLE `tbl_encuestador`
  MODIFY `id_encuestador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
