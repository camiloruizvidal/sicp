...
AUTO_INCREMENT=4 AVG_ROW_LENGTH=4096 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
AUTO_INCREMENT=9 AVG_ROW_LENGTH=2730 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
CREATE TABLE `tbl_tarjeta_familiar` (
  ...
  `id_responsable` INTEGER(11) DEFAULT NULL,
...
#
# Data for the `tbl_car_registro` table  (LIMIT -496,500)
#
...
INSERT INTO `tbl_tarjeta_familiar` (`id_tarjeta_familiar`, `fecha_apertura`, `codigo`, `sisben_ficha`, `sisben_puntaje`, `sisben_nivel`, `direccion`, `id_zona`, `telefono`, `id_municipio`, `id_corregimiento`, `id_vereda`, `portabilidad`, `cambio_domicilio`, `proxima_visita`, `id_responsable`) VALUES 
  (1,'2017-09-03 19:28:11','6',1,1.000,1,'1',2,'1',430,0,-1,'no','no','2017-09-15',1);
COMMIT;
