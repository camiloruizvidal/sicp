...
AUTO_INCREMENT=89 AVG_ROW_LENGTH=186 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=88 AVG_ROW_LENGTH=188 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
INSERT INTO `tbl_car_categoria` (`id_car_categoria`, `descripcion`, `orden`) VALUES 
  (1,'Salud infantil',2),
  (2,'Enfermedades no transmisibles',3),
  (3,'Salud mental',4),
...
#
# Data for the `tbl_car_variables` table  (LIMIT -411,500)
#
...
#
# Data for the `tbl_car_variablexcategoria` table  (LIMIT -412,500)
#
...
INSERT INTO `tbl_persona` (`id_persona`, `id_documento_tipo`, `id_tarjeta_familiar`, `id_estado_civil`, `id_asegurador`, `id_nivel_educativo`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `documento`, `sexo`, `fecha_nacimiento`, `es_cabeza_familia`) VALUES 
  (1,1,2147483647,2,1,1,'1','2','3','5','12','Masculino','0000-00-00','0'),
  (3,1,1,2,1,1,'camilo','ernesto','ruiz','vida','1061716139','Masculino','1989-02-13','0'),
  (4,1,23,2,2,2,'camilo','ernesto','ruiz','vidal','1','Masculino','1989-02-13','0');
COMMIT;

#
# Data for the `tbl_tarjeta_familiar` table  (LIMIT -479,500)
#
