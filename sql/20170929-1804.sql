...
AUTO_INCREMENT=27 AVG_ROW_LENGTH=2048 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
AUTO_INCREMENT=17 AVG_ROW_LENGTH=4096 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
AUTO_INCREMENT=11 AVG_ROW_LENGTH=16384 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
#
# Data for the `tbl_asegurador` table  (LIMIT -473,500)
#
...
INSERT INTO `tbl_car_programas_actividades_valores` (`id_car_programas_actividades`, `id_car_actividades`, `rango_inicio`, `rango_fin`, `rango_tipo`, `dosis`, `intervalo`, `intervalo_tipo`, `sexo`) VALUES 
  ...
  (6,2,5,5,'años',5,4,'semanas','ambos'),
...
INSERT INTO `tbl_persona` (`id_persona`, `id_documento_tipo`, `documento`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `id_tarjeta_familiar`, `id_estado_civil`, `id_asegurador`, `id_nivel_educativo`, `sexo`, `fecha_nacimiento`, `id_persona_familiaridad`) VALUES 
  (1,1,'1','niño','1','apellido','2',1,1,1,1,'Femenino','2017-08-28',1),
  (2,1,'2','2','2','2','2',1,1,2,2,'Femenino','2017-08-02',1),
  (3,1,'121','1212','1212','1212','1212',1,1,1,1,'Masculino','2017-08-02',1),
  (4,1,'3123123','1212233','12124324','121242342','1212342342',1,1,1,1,'Masculino','2017-08-03',10),
  (5,1,'milo','1212233','12124324','121242342','1212342342',1,1,1,1,'Masculino','2017-08-03',10),
  (6,1,'12','12','112','112','1212',1,2,1,1,'Masculino','2017-08-27',1),
  (7,1,'1071263','12','112','112','1212',1,2,1,1,'Masculino','2000-04-11',1),
  (8,1,'1061716139','Camilo','Ernesto','Ruiz','Vidal',1,1,7,1,'Masculino','1989-02-13',1),
  (9,1,'1061699111','Juliana','Andrea','Ruiz','Vidal',2,1,7,2,'Femenino','1987-07-06',1),
  (10,5,'1234','1','1','1','1',2,2,4,1,'Masculino','2017-08-01',1),
  (11,5,'12343','2','2','2','2',2,2,4,1,'Masculino','2017-08-10',1);
COMMIT;
...
#
# Data for the `tbl_tarjeta_familiar` table  (LIMIT -493,500)
#
...
#
# Data for the `tbl_veredas` table  (LIMIT -498,500)
#
