...
AUTO_INCREMENT=28 AVG_ROW_LENGTH=2048 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
CREATE TABLE `tbl_car_programas_actividades_valores` (
  `id_car_programas_actividades` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `id_car_actividades` INTEGER(11) DEFAULT NULL,
  ...
  PRIMARY KEY (`id_car_programas_actividades`),
  UNIQUE KEY `tbl_car_programas_actividades_valores_idx1` (`id_car_actividades`, `rango_inicio`, `rango_fin`, `rango_tipo`, `dosis`, `intervalo`, `intervalo_tipo`, `sexo`)
)ENGINE=InnoDB
AUTO_INCREMENT=147 AVG_ROW_LENGTH=1820 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=22 AVG_ROW_LENGTH=4096 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
AUTO_INCREMENT=100 AVG_ROW_LENGTH=186 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
AUTO_INCREMENT=99 AVG_ROW_LENGTH=188 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
CREATE TABLE `tbl_codigos` (
  ...
  `activo` VARCHAR(20) COLLATE latin1_swedish_ci DEFAULT 'si',
...
#
# Structure for the `tbl_corregimientos` table : 
#

CREATE TABLE `tbl_corregimientos` (
  `id_corregimiento` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `descripcion` VARCHAR(200) COLLATE latin1_swedish_ci DEFAULT NULL,
...
AUTO_INCREMENT=7 AVG_ROW_LENGTH=8192 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
AUTO_INCREMENT=6 AVG_ROW_LENGTH=8192 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;

#
# Structure for the `tbl_perfil_tipo` table : 
#

CREATE TABLE `tbl_perfil_tipo` (
  `id_perfil_tipo` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `descripcion` VARCHAR(200) COLLATE latin1_swedish_ci DEFAULT NULL,
  PRIMARY KEY (`id_perfil_tipo`)
)ENGINE=InnoDB
...
CREATE TABLE `tbl_persona` (
  ...
  `id_rango` INTEGER(11) DEFAULT NULL,
  `id_regimen` INTEGER(11) DEFAULT NULL,
  `es_cabeza_familia` CHAR(2) COLLATE utf8_general_ci NOT NULL DEFAULT 'no',
  PRIMARY KEY (`id_persona`)
)ENGINE=InnoDB
AUTO_INCREMENT=12 AVG_ROW_LENGTH=2340 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
#
# Structure for the `tbl_regimen` table : 
#

CREATE TABLE `tbl_regimen` (
  `id_regimen` INTEGER(11) NOT NULL AUTO_INCREMENT,
  `descripcion` VARCHAR(200) COLLATE latin1_swedish_ci NOT NULL,
  PRIMARY KEY (`id_regimen`)
)ENGINE=InnoDB
AUTO_INCREMENT=9 AVG_ROW_LENGTH=2340 CHARACTER SET 'latin1' COLLATE 'latin1_swedish_ci'
COMMENT=''
;
...
CREATE TABLE `tbl_tarjeta_familiar` (
  ...
  `telefono` VARCHAR(20) COLLATE utf8_general_ci DEFAULT NULL,
  `id_municipio` INTEGER(11) DEFAULT NULL,
  `id_corregimiento` INTEGER(11) DEFAULT NULL,
  `id_vereda` INTEGER(11) DEFAULT NULL,
  `portabilidad` VARCHAR(2) COLLATE utf8_general_ci DEFAULT 'no' COMMENT 'si\r\nno',
  `cambio_domicilio` CHAR(2) COLLATE utf8_general_ci DEFAULT 'no' COMMENT 'si\r\nno',
  `proxima_visita` DATE DEFAULT NULL,
  PRIMARY KEY (`id_tarjeta_familiar`),
  UNIQUE KEY `codigo` (`codigo`),
  UNIQUE KEY `codigo_2` (`codigo`)
)ENGINE=InnoDB
AUTO_INCREMENT=12 AVG_ROW_LENGTH=16384 CHARACTER SET 'utf8' COLLATE 'utf8_general_ci'
COMMENT=''
;
...
#
# Structure for the `tbl_veredas` table : 
#
...
#
# Data for the `tbl_asegurador` table  (LIMIT -472,500)
#
...
#
# Data for the `tbl_car_programas_actividades_valores` table  (LIMIT -375,500)
#
...
INSERT INTO `tbl_car_programas_actividades_valores` (`id_car_programas_actividades`, `id_car_actividades`, `rango_inicio`, `rango_fin`, `rango_tipo`, `dosis`, `intervalo`, `intervalo_tipo`, `sexo`) VALUES 
  ...
  (95,48,45,80,'años',1,1,'años','Masculino'),
  (96,48,45,80,'años',1,1,'años','Femenino'),
  (97,49,45,80,'años',1,1,'años','Femenino'),
  (98,49,45,80,'años',1,1,'años','Masculino'),
  (99,50,45,80,'años',1,1,'años','Masculino'),
  (100,50,45,80,'años',1,1,'años','Femenino'),
  (101,51,45,80,'años',1,1,'años','Femenino'),
  (102,51,45,80,'años',1,1,'años','Masculino'),
  (103,52,45,80,'años',1,1,'años','Masculino'),
  (104,52,45,80,'años',1,1,'años','Femenino'),
  (105,53,45,80,'años',1,1,'años','Femenino'),
  (106,53,45,80,'años',1,1,'años','Masculino'),
  (107,54,45,80,'años',1,1,'años','Masculino'),
  (108,54,45,80,'años',1,1,'años','Femenino'),
  (109,55,45,80,'años',1,1,'años','Femenino'),
  (110,55,45,80,'años',1,1,'años','Masculino'),
...
#
# Data for the `tbl_car_variables` table  (LIMIT -400,500)
#
...
#
# Data for the `tbl_car_variablexcategoria` table  (LIMIT -401,500)
#
...
#
# Data for the `tbl_codigos` table  (LIMIT -497,500)
#

INSERT INTO `tbl_codigos` (`id_codigos`, `codigo_inicio`, `codigo_fin`, `codigo_next_value`, `id_usuario`, `activo`) VALUES 
  (1,1,1000,1000,1,'si'),
  (2,3000,4000,3006,1,'si');
COMMIT;

#
# Data for the `tbl_corregimientos` table  (LIMIT -498,500)
#
...
#
# Data for the `tbl_documento_tipo` table  (LIMIT -494,500)
#
...
#
# Data for the `tbl_estado_civil` table  (LIMIT -493,500)
#
...
#
# Data for the `tbl_nivel_educativo` table  (LIMIT -494,500)
#
...
#
# Data for the `tbl_perfil_tipo` table  (LIMIT -497,500)
#
...
#
# Data for the `tbl_persona` table  (LIMIT -488,500)
#

INSERT INTO `tbl_persona` (`id_persona`, `id_documento_tipo`, `documento`, `nombre1`, `nombre2`, `apellido1`, `apellido2`, `id_tarjeta_familiar`, `id_estado_civil`, `id_nivel_educativo`, `sexo`, `fecha_nacimiento`, `id_persona_familiaridad`, `tipo_afiliado`, `id_asegurador`, `id_rango`, `id_regimen`, `es_cabeza_familia`) VALUES 
  (1,1,'1','niño','1','apellido','2',1,1,1,'Masculino','1990-08-01',1,'COTIZANTE',1,1,1,'no'),
  (2,1,'2','2','2','2','2',1,1,2,'Femenino','2017-08-02',1,'COTIZANTE',2,1,1,'no'),
  (3,1,'121','1212','1212','1212','1212',1,1,1,'Masculino','2017-08-02',1,'COTIZANTE',1,1,1,'no'),
  (4,1,'3123123','1212233','12124324','121242342','1212342342',1,1,1,'Masculino','2017-08-03',10,'COTIZANTE',1,1,1,'no'),
  (5,1,'milo','1212233','12124324','121242342','1212342342',1,1,1,'Masculino','2017-08-03',10,'COTIZANTE',1,1,1,'no'),
  (6,1,'12','12','112','112','1212',1,2,1,'Masculino','2017-08-27',1,'COTIZANTE',1,1,1,'no'),
  (7,1,'1071263','12','112','112','1212',1,2,1,'Masculino','2000-04-11',1,'COTIZANTE',1,1,1,'no'),
  (8,1,'1061716139','Camilo','Ernesto','Ruiz','Vidal',1,1,1,'Masculino','1989-02-13',1,'COTIZANTE',7,1,1,'no'),
  (9,1,'1061699111','Juliana','Andrea','Ruiz','Vidal',2,1,2,'Femenino','1987-07-06',1,'COTIZANTE',7,1,1,'no'),
  (10,5,'1234','1','1','1','1',2,2,1,'Masculino','2017-08-01',1,'COTIZANTE',4,1,1,'no'),
  (11,5,'12343','2','2','2','2',2,2,1,'Masculino','2017-08-10',1,'COTIZANTE',4,1,1,'no');
COMMIT;
...
#
# Data for the `tbl_regimen` table  (LIMIT -491,500)
#
...
#
# Data for the `tbl_tarjeta_familiar` table  (LIMIT -492,500)
#

INSERT INTO `tbl_tarjeta_familiar` (`id_tarjeta_familiar`, `fecha_apertura`, `codigo`, `sisben_ficha`, `sisben_puntaje`, `sisben_nivel`, `direccion`, `id_zona`, `telefono`, `id_municipio`, `id_corregimiento`, `id_vereda`, `portabilidad`, `cambio_domicilio`, `proxima_visita`) VALUES 
  (1,'2017-08-29 18:14:05','82',1,1.000,1,'1',1,'1',NULL,NULL,NULL,'no','no',NULL),
  (2,'2017-08-29 19:26:18','83',1,1.000,1,'carrera 48 a numero 2-24',1,'3186234042',NULL,NULL,NULL,NULL,NULL,NULL),
  (7,'2017-08-29 19:48:31','1000',1,1.000,1,'1',1,'1',NULL,NULL,NULL,'no','no','2017-08-29'),
  (8,'2017-08-29 20:02:20','3001',1,1.000,1,'1',1,'1',4,NULL,NULL,'no','no','2017-08-29'),
  (9,'2017-08-29 20:04:38','3002',23132,21.000,3,'1',1,'1',128,NULL,NULL,'no','no','2017-08-16'),
  (10,'2017-08-29 20:06:34','3004',2123,32423.000,3242,'1',1,'1',6,NULL,NULL,'no','no','2017-08-22'),
  (11,'2017-08-30 16:36:38','3005',1,1.000,1,'1',5,'1',430,NULL,NULL,'no','no','2017-08-30');
COMMIT;

#
# Data for the `tbl_usuario` table  (LIMIT -497,500)
#
...
INSERT INTO `tbl_usuario` (`id_usuario`, `login`, `pass`, `id_perfil_tercero`, `id_perfil_tipo`) VALUES 
  ...
  (2,'2','c81e728d9d4c2f636f067f89cc14862c',1,2);
COMMIT;

#
# Data for the `tbl_veredas` table  (LIMIT -495,500)
#
...
#
# Data for the `tbl_zona` table  (LIMIT -494,500)
#
